...
import com.cloud.eurekaclient.redis.lock.impl.RedissionDistributedLock;
...
public class RedissonAutoConfiguration {
    ...
    RedissonClient redissonSentinel() {
        ...
        System.out.println("主服务器名称:"+redissonProperties.getMasterName());
        System.out.println("主服务器地址"+ redissonProperties.getSentinelAddresses());
    ...
    RedissonClient redissonClient() {
        Config config = new Config();
        System.out.println("主服务器名称:"+redissonProperties.getAddress());
        System.out.println("主服务器地址"+ redissonProperties.getSentinelAddresses());
    ...
    DistributedLock distributedLock(RedissonClient redissonClient) {
        DistributedLock lock = new RedissionDistributedLock(redissonClient);
        return lock;
    }
